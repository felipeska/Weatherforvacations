package com.felipecb.weatherforvacations.data.executor;
...
/**
 * Decorated {@link java.util.concurrent.ThreadPoolExecutor}, for execute Jobs in the Application.
 *
...
@Singleton public class JobExecutor implements ThreadExecutor {
  ...
  private static class JobThreadFactory implements ThreadFactory {
    private static final String THREAD_NAME = "weatherforvacations_";
